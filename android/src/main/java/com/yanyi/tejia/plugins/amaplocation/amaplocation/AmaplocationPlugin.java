package com.yanyi.tejia.plugins.amaplocation.amaplocation;
...
public class AmaplocationPlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    private static final String CHANNEL_METHOD_LOCATION = "amap_location_method";
    private static final String CHANNEL_STREAM_LOCATION = "amap_location_event";
    ...
    private Map<String, AMapLocationClientImpl> locationClientMap = new HashMap<>(10);
    ...
    public static void registerWith(Registrar registrar) {
        ...
        methodChannel.setMethodCallHandler(new AmaplocationPlugin());

        final EventChannel eventChannel = new EventChannel(registrar.messenger(), CHANNEL_STREAM_LOCATION);
        eventChannel.setStreamHandler(new AmaplocationPlugin());
    }
